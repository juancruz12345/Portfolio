...
export default function Cards(){
    return(
        ...
        <div className="cards">
          ...
          <Card className='card'>
              ...
              <Link className='link' to={'https://github.com/juancruz12345/Vivero-La-Jardineta'}>
                 ...
                 <Card.Footer>
                   ...
                   <Image loading='lazy' src='public\icons\vite-svgrepo-com.svg'></Image>
                   <Image loading='lazy' src='public\icons\js-svgrepo-com.svg'></Image>
          ...
          <Card className='card'>
             <Card.Img className="cardImg" src='public\proyects\chat.png' variant='top'></Card.Img>
               <Card.Body className='cardBody'>
                 <div className='cardDiv'>
                 ...
                 <Card.Footer>
                   <Stack direction='horizontal' className='iconsCard' gap={2}>
                   <Image loading='lazy' src='public\icons\socket-dot-io-svgrepo-com(1).svg'></Image>
                   <Image loading='lazy' src='public\icons\js-svgrepo-com.svg'></Image>
                   <Image loading='lazy' src='public\icons\html-svgrepo-com.svg'></Image>
                   <Image loading='lazy' src='public\icons\css-3-svgrepo-com.svg'></Image>
                   </Stack>
                 </Card.Footer>
             </Card>
              ...
              <Card className='card'>
               <Card.Img className="cardImg" src='public\proyects\todo.png' variant='top'></Card.Img>
               <Card.Body className='cardBody'>
               <div className='cardDiv'>
              ...
              <Link className='link' to={'https://github.com/juancruz12345/TODO-app'}>
                 ...
                 <Card.Footer>
                   ...
                   <Image loading='lazy' src='public\icons\vite-svgrepo-com.svg'></Image>
                   <Image loading='lazy' src='public\icons\js-svgrepo-com.svg'></Image>
                   <Image loading='lazy' src='public\icons\typescript-icon-svgrepo-com.svg'></Image>
                   <Image loading='lazy' src='public\icons\react-svgrepo-com.svg'></Image>
                   </Stack>
                 </Card.Footer>
             </Card>
             ...
             <Card className='card'>
             <Card.Img className="cardImg" src='public\proyects\drawingapp.png' variant='top'></Card.Img>
               <Card.Body className='cardBody'>
                 <div className='cardDiv'>
             ...
             <Card className='card'>
              <Card.Img className="cardImg" src='public\proyects\tetris.png' variant="top"></Card.Img>
               <Card.Body className='cardBody'>
